...
@app_views.route('/states/<state_id>/cities', methods=['GET'], strict_flashes=FALSE)
...
@app_views.route('/states/<state_id>/cities/', methods=['POST'], strict_flashes=FALSE))
...
@app_views.route('/cities/<city_id>', methods=['GET']), strict_flashes=FALSE)
...
@app_views.route('/cities/<city_id>', methods=['DELETE']), strict_flashes=FALSE)
...
@app_views.route('/cities/<city_id>', methods=['PUT'], strict_flashes=FALSE)
